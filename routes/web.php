...
Route::get('/language/{code?}', 'WebsiteController@language')->name('language');
...
//    Route::group(['middleware' => ['demo']], function () {
        ...
        Route::get('language/create', 'LanguageController@create')->name('admin.language.create');
        Route::post('language/create', 'LanguageController@store')->name('admin.language.store');
        Route::get('language/{language}', 'LanguageController@edit')->name('admin.language.edit');
        Route::put('language/{language}', 'LanguageController@update')->name('admin.language.update');
        Route::delete('language/{language}', 'LanguageController@delete')->name('admin.language.delete');
        Route::get('/language/keyword/{id}', 'LanguageController@keywordEdit')->name('admin.language.keywordEdit');
        Route::put('/language/keyword/{id}', 'LanguageController@keywordUpdate')->name('admin.language.keywordUpdate');
        Route::post('/language/importJson', 'LanguageController@importJson')->name('admin.language.importJson');
        Route::post('store-key/{id}', 'LanguageController@storeKey')->name('admin.language.storeKey');
        Route::put('update-key/{id}', 'LanguageController@updateKey')->name('admin.language.updateKey');
        Route::delete('delete-key/{id}', 'LanguageController@deleteKey')->name('admin.language.deleteKey');
