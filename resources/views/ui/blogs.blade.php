                                ...
                                <div class="single-blog">
                                    ...
                                    <div class="blog-txt">
                                        ...
                                        <h3 class="blog-title"><a
                                                href="{{route('info',[str_slug($data->title), $data->id])}}">@lang($data->title)</a>
                                        </h3>
                                ...
                                @foreach($popular as $data)
                                    <div class="single-popular-post">
                                        <div class="popular-post-img-wrapper">
                                            <img src="{{asset('public/images/blog/'.$data->image)}}"
                                                 alt="{{$data->title}}">
                                        </div>
                                        <div class="popular-post-txt">
                                            <h5 class="popular-post-title"><a
                                                    href="{{route('info',[str_slug($data->title), $data->id])}}">{{str_limit(trans($data->title),30)}}</a>
                                            </h5>
