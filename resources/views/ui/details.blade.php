                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-blog">
                            ...
                            <div class="blog-txt">
                                ...
                                <h3 class="blog-title"><a href="{{route('info',[str_slug($data->title), $data->id])}}">@lang($data->title)</a></h3>
                                <p class="blog-summary">{{str_limit(strip_tags(trans($data->details)),200)}}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
