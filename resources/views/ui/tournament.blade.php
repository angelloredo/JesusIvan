                                                ...
                                                <div class="col-sm-9 col-md-4 col-lg-3">
                                                    <div class="sport-table-title">
                                                        <div class="sport-table-title-item sport-table-title-item-left">
                                                            <span class="sport-table-title-team">  {{trans($question->question)}}</span>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title modal-sport-confrontation text-white font-20" id="sportModalTitle">@lang('Prediction Now')</h5>
                ...
                <form action="{{route('prediction')}}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <p class="modal-sport-win">
                            ...
                            <span class="font-weight-bold"><span class="wining-rate"></span> {{trans($basic->currency)}}</span>
                        </p>
