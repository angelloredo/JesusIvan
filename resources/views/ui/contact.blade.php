                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="part-text-top">
                            <h2 class="subtitle">@lang($page_title)</h2>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <form action="{{route('contact.submit')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-element"><input type="text" name="name" placeholder="@lang('Name')" required></div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-element"><input type="email" name="email" placeholder="@lang('Email')" required></div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-element"><input type="text" name="subject" placeholder="@lang('Subject')"></div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-element">
                                        <textarea name="message" cols="30" rows="10" placeholder="@lang('Message')"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-element">
