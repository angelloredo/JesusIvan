                                       ...
                                       <div class="col-md-4">
                                           <ul class="list-group">
                                               <li class="list-group-item font-weight-bold">
                                                   <img src="{{asset('public/images/withdraw/'. $withdraw->method->image)}}" class="card-img-top w-100p" alt="{{optional($withdraw->method)->name}}" >

                                               </li>
                                               <li class="list-group-item font-weight-bold">@lang('Request Amount') : <span class="float-right text-success">{{formatter_money($withdraw->amount)}} {{trans($basic->currency_sym)}}</span></li>
                                               <li class="list-group-item font-weight-bold">@lang('Charge Amount') : <span class="float-right text-danger">{{formatter_money($withdraw->charge)}} {{trans($basic->currency_sym)}}</span></li>
                                               <li class="list-group-item font-weight-bold">@lang('Total Payable') : <span class="float-right text-danger">{{formatter_money($withdraw->net_amount)}} {{trans($basic->currency_sym)}}</span></li>
                                               <li class="list-group-item font-weight-bold">@lang('Available Balance') : <span class="float-right text-success">{{formatter_money(Auth::user()->balance - $withdraw->net_amount)}} {{trans($basic->currency_sym)}}</span></li>
                                           </ul>
                                       </div>
