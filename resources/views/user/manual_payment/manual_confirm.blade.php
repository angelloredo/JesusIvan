                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        ...
                                        <p class="text-center mt-2 text-white" >@lang('You have requested to deposit') <b
                                            ...
                                            <b class="text-success">{{getAmount($data['final_amo']) .' '.trans($data['method_currency']) }}</b> @lang('for successful payment')
                                        </p>

                                        <p class="my-4 text-center text-white manual-desc">@lang($method->description)</p>
                                        <p class="text-center text-white my-3 font-weight-bold">@lang('Delay') @lang($extra->delay)</p>
