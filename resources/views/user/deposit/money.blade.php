                                ...
                                <div class="card-body my-5 shadow ">
                                    ...
                                    <div class="form-row align-items-center ">
                                        <div class="col-auto">
                                            <div class="md-form">
                                                <label for="Amount"
                                                       class="font-weight-bold"> @lang('Enter Amount')</label>
                                                <input type="text" class="form-control amount mb-2" placeholder="0.00"
                                                       onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                <label class="sr-only" for="inlineFormInputMD">@lang('Amount')</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="md-form ">
                                                <button type="button" class="btn btn-dark  mt-4 request-button">@lang('Submit')</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
