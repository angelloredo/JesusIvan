                    ...
                    <table class="table">
                        ...
                        @forelse($deposits as $deposit)
                            <tr>
                                ...
                                <td class="text-uppercase">{{ $deposit->trx }}</td>
                                <td><a href="{{ route('user.single', $deposit->user_id) }}">{{ $deposit->user->username }}</a></td>
                                <td>{{ $deposit->gateway_currency()->name }}</td>
                                <td class="">{{ number_format($deposit->amount, $basic->decimal ) }} {{ $basic->currency }}</td>
                                ...
                                <td class="">{{ getAmount($deposit->final_amo) }} {{$deposit->method_currency}}</td>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('deposit.approve')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Are you sure to <span class="">approve</span> <span class=" withdraw-amount text-success"></span> deposit of <span class=" withdraw-user"></span>?</p>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('deposit.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Are you sure to <span class="">reject</span> <span class=" withdraw-amount text-success"></span> deposit of <span class=" withdraw-user"></span>?</p>
    ...
    <script>
        $('.approveBtn').on('click', function() {
            ...
            details.map(function (item, i) {
                if (item[1].type == 'file') {
                    ...
                    var singleInfo = `<span class=" ml-3">${item[1].field_name}</span>  `;
                }
                list[i] = ` <li class="list-group-item my-1"><span class=" "> ${item[0].replace('_', " ")} </span> : ${singleInfo}</li>`
            });
        ...
        $('.rejectBtn').on('click', function() {
            ...
            details.map(function (item, i) {
                ...
                list[i] = ` <li class="list-group-item"><span class=" "> ${item[0].replace('_', " ")} </span> : ${singleInfo}</li>`
            });
