...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
              ...
              </span> {!! optional($ques->match)->name !!}  </h3>
                    ...
                    <table class="table">
                        ...
                        @foreach($betoption as $k=>$data)
                            <tr>
                                ...
                                <td data-label="Ratio"><strong> {{$data->ratio1}} X {{$data->ratio2}}</strong></td>
                                @php
            ...
            <form method="post" action="{{route('createNewOption')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="number"   class="form-control  ratio-left" step="0.01" name="ratio1"  value="1" required disabled>
                        <span class="ratio-center" > X</span>
            ...
            <form method="post" action="{{route('update.option')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="number"   class="form-control  ratio-left ronnie_ratio1" step="0.01" name="ratio1"  value="1" required disabled>
                        <span class="ratio-center">X</span>
