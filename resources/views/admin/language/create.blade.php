        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card card-primary card-form m-0 m-md-4 my-4 m-md-0">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.language.index') }}" class="btn btn-sm btn-success float-right mb-3"><i
                    ...
                    <form method="post" action="{{ route('admin.language.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mt-5 justify-content-center">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-success">
                                                <label class="form-check-label">
                                                    <input type="checkbox" name="is_active" class="form-check-input" checked>  Enabled <i class="input-helper"></i><i class="input-helper"></i></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-success">
                                                <label class="form-check-label">
                                                    <input type="checkbox" name="rtl" class="form-check-input" checked>  Yes <i class="input-helper"></i><i class="input-helper"></i></label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button class="btn waves-effect waves-light btn-rounded btn-success btn-block mt-3">
