                        ...
                        <table class="table table-responsive">
                            ...
                            @foreach($logs as $k=>$data)
                                <tr class="result-table-tr">
                                    ...
                                    <td data-label="@lang('Match')">{!! optional($data->match)->name !!}</td>
                                    <td data-label="@lang('Question')">{{optional($data->ques)->question }}</td>
                                    <td data-label="@lang('Threat')">{{optional($data->betoption)->option_name }} </td>
